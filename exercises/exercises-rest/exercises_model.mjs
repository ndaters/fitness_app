...
const replaceExercise = async (_id, name, reps, weight, unit, date) => {
    ...
    // return result.nModified;  // changed nModified to modifiedCount
 ...
 */
 const deleteById = async (_id) => {
    ...
    // Return the count of deleted document. Since we called deleteOne, this will 
    // be either 0 or 1.
    return result.deletedCount;
}

export { findExercises, createExercise, replaceExercise, findExerciseById, deleteById };